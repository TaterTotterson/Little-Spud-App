...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 37
        versionCode = System.getenv("LITTLE_SPUD_VERSION_CODE")?.toIntOrNull()?.takeIf { it > 0 } ?: 3
        versionName = System.getenv("LITTLE_SPUD_VERSION_NAME")?.trim()?.ifBlank { null } ?: "1.3.1"
